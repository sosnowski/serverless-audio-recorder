...
This is a sample template for aws-audio-recorder - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name aws-audio-recorder --query 'Stacks[].Outputs'
```
